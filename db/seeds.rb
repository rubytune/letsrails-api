...
def get_deals_for_vertical( vertical, city )
  doc = get_html "http://es.letsbonus.com/#{vertical}/#{city.name}"
  doc.css(".listOffers article").each do |a|
    ...
    deal.type = vertical == 'ocio' ? 'LocalDeal' : 'EscapeDeal'
...
get_deals_for_vertical 'ocio', barcelona
get_deals_for_vertical 'viajes', barcelona
